...
const API_KEY = "CG-pm2VK1vBsxKUaGL5cY457ics"
...
const marcketChart = (coin) => `${BASE_URL}/coins/${coin}/market_chart?vs_currency=usd&days=7`


export {getCoinList , searchCoin , marcketChart}